...
bot.on('photo', async (msg) => {
  ...
  if (!caption.includes('\n')) {
    return bot.sendMessage(chatId, '❌ Please include name, description, and at least one quantity option');
  }
...
bot.onText(/✅ Confirm Order/, (msg) => {
  ...
  bot.sendMessage(chatId, '✅ Your order has been placed! You will be notified when it is confirmed.');
});
